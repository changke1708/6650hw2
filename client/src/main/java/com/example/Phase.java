                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        for (int j = 0; j < iterations; j++) {
                            ...
                            webClient.postStepCount(users[0], dayNum, intervals[0], stepCounts[0]);
                            ...
                            webClient.postStepCount(users[1], dayNum, intervals[1], stepCounts[1]);
                            ...
                            webClient.getCurrentDay(users[0]);
                            ...
                            webClient.getSingleDay(users[1], dayNum);
                            ...
                            webClient.postStepCount(users[2], dayNum, intervals[2], stepCounts[2]);
